...
#
#
#clusters <- c("336","268","378","375","377","383","311",
#              "303","309","301","299","329_333","327")
#
...
#
#saveRDS(seu,'seu.harmony.SST.rds')

seu <- readRDS('seu.harmony.SST.rds')
...
saveRDS(markers, 'seu.harmony.SST.markers.rds')
saveRDS(seu,'seu.harmony.SST.rds')
...
################################################
markers <- readRDS('seu.harmony.SST.markers.rds')
seu <- readRDS('seu.harmony.SST.rds')
...
write.csv(markers2, 'SST.markers.csv',row.names = FALSE, quote = F)
