...
#
#
#clusters <- c("226","192","199","198","202","201","204_211","206")
#
...
#
#saveRDS(seu,'seu.harmony.PAX6.rds')

seu <- readRDS('seu.harmony.PAX6.rds')
...
saveRDS(markers, 'seu.harmony.PAX6.markers.rds')
saveRDS(seu,'seu.harmony.PAX6.rds')


#################################################
markers <- readRDS('seu.harmony.PAX6.markers.rds')
seu <- readRDS('seu.harmony.PAX6.rds')
