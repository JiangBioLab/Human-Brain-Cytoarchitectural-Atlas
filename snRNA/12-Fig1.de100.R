...
seu <- readRDS('seu.harmony.anno.de100.rds')

seu$hicat_cluster_newID <- factor(seu$hicat_cluster_newID, 
                            levels = rev(c('9','94','64','62','5','78','55','48','47','40','89','71','2',
...
DimPlot(seu, group.by = 'hicat_cluster_newID', cols = rev(supertype_color))
...
############## cell composition ###################
cluster_dis<-cbind(as.vector(seu$hicat_cluster_newID),as.vector(seu$individual))
...
cluster_dis$cluster<-factor(cluster_dis$cluster,
                            levels=c('9','94','64','62','5','78','55','48','47','40',
...
##cluster_individual_composition.pdf
##pdf 3x20
...
cluster_dis<-cbind(as.vector(seu$hicat_cluster_newID),as.vector(seu$region))
colnames(cluster_dis)<-c('cluster','region')
cluster_dis<-as.data.frame(cluster_dis)
cluster_dis$cluster<-factor(cluster_dis$cluster,
                            levels=c('9','94','64','62','5','78','55','48','47','40','89','71','2',
                                     '52','73','22','82','45','25','56','70','3','68','54','4','44',
                                     '46','92','67','30','35','23','36','65','61','12','1','18','6',
                                     '21','7','11','63','19','97','16','80','96','8','76','49','50',
                                     '59','81','84','42','43','77','28','13','38','91','87','20','17',
...
library(ggplot2)
library(RColorBrewer)
##cluster_region_composition.pdf
##pdf 3x20
ggplot(cluster_dis, aes(cluster)) + 
...
cluster_dis<-table(seu$hicat_cluster_newID,seu$region)
cluster_dis_r <- cluster_dis/rowSums(cluster_dis)
cluster_dis_r <- cluster_dis_r[rev(c('9','94','64','62','5','78','55','48','47','40','89','71','2',
                                     '52','73','22','82','45','25','56','70','3','68','54','4','44',
                                     '46','92','67','30','35','23','36','65','61','12','1','18','6',
                                     '21','7','11','63','19','97','16','80','96','8','76','49','50',
                                     '59','81','84','42','43','77','28','13','38','91','87','20','17',
...
library(pheatmap)
library(RColorBrewer)
#pdf cluster_region_composition_ratio.pdf 19x3.5
...
for(i in 1:dim(cluster_dis_r)[1]){
  for(j in 1:dim(cluster_dis_r)[2]){
    cluster_dis_r_samples[i,j]<-length(unique(seu$individual[seu$hicat_cluster_newID==rownames(cluster_dis_r)[i] & seu$region==colnames(cluster_dis_r)[j]]))
  }
}
cluster_dis_r_samples <- cluster_dis_r_samples[,c('A8','A9','A3','A5','A14','A12','A4','A7','A10','A13','A11','A1','A2','A6')]

#pdf cluster_region_composition_samples.pdf 19x3.5
...
cluster_dis<-cluster_dis[rev(c('9','94','64','62','5','78','55','48','47','40','89','71','2',
                               '52','73','22','82','45','25','56','70','3','68','54','4','44',
                               '46','92','67','30','35','23','36','65','61','12','1','18','6',
                               '21','7','11','63','19','97','16','80','96','8','76','49','50',
                               '59','81','84','42','43','77','28','13','38','91','87','20','17',
...
#pdf cluster_region_composition_cells.pdf 19x3.5
...
# cell_number_log2.pdf 3x20
barplot(log2(table(seu$hicat_cluster_newID)[c('9','94','64','62','5','78','55','48','47','40','89','71','2',
                                              '52','73','22','82','45','25','56','70','3','68','54','4','44',
                                              '46','92','67','30','35','23','36','65','61','12','1','18','6',
                                              '21','7','11','63','19','97','16','80','96','8','76','49','50',
                                              '59','81','84','42','43','77','28','13','38','91','87','20','17',
...
seu$hicat_cluster_newID <- factor(seu$hicat_cluster_newID,
                            levels=c('9','94','64','62','5','78','55','48','47','40','89','71','2',
                                     ...
                                     '31','33','14','93','10','75','41','66','26','90','32','72','29',
                                     '69','74','86','85','60','57'))
##marker_dotplot.pdf 22x9
DotPlot(seu,features = genes,group.by = 'hicat_cluster_newID') + RotatedAxis()
