...
######## supertypes #######################
seu$hicat_cluster_supertypes <- as.vector(seu$hicat_cluster_merge_anno)
...
write.table(meta2,'Brain_subClusteringID_seurat_merge_v4.txt',col.names = T,row.names = F,sep='\t',quote = F)
